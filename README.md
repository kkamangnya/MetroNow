...
MetroNow는 선택한 서울 지하철 노선·역·방향의 실시간 도착정보를 앱과 Android 홈 화면 위젯에서 빠르게 확인하는 Kotlin 앱입니다. 서울 열린데이터광장의 `realtimeStationArrival` API를 사용하며, 앱 화면과 위젯은 API DTO가 아닌 도메인 모델만 사용합니다.
